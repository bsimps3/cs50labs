...
//write a function header line right here for the spot_is_taken() function which is used on lines 82 and 180  
{
  //fill in this function so that it will return true if the do-while loops in player_turn() and computer_turn() should keep looping.  
  //That is... this should return true if there is an 'X' or 'O' in the given spot.  It should return false if that spot has not been played..
}
